  ...
  return (
    <div className="py-20 px-4 max-w-6xl mx-auto">
      ...
      <p className="mb-4 text-slate-700">
        {`        "Welcome to our dedicated platform for single-family homes! At [Website
        Name], we're passionate about helping individuals and families find
        ...
        to your needs. With a user-friendly interface and detailed property
